"""Códigos para plot de volcano plots de expressão diferencial para cérebro e sangue"""
...
files = [
    ('../data/processed/cérebro/expressão diferencial - somente TEA_feminino em relação ao masculino.csv', 'Somente TEA feminino x TEA masculino'),
    ('../data/processed/cérebro/expressão diferencial - TEA feminino (em relação ao controle feminino).csv', 'TEA feminino x controle feminino'),
    ('../data/processed/cérebro/expressão diferencial - TEA feminino (em relação ao TEA masculino).csv', 'TEA feminino x TEA masculino'),
    ('../data/processed/cérebro/expressão diferencial - TEA masculino (em relação ao controle masculino).csv', 'TEA masculino x controle masculino'),
    ('../data/processed/sangue/expressão diferencial sangue - TEA feminino (em relação ao TEA masculino).csv', 'Sangue TEA feminino x TEA masculino'),
    ('../data/processed/sangue/expressão diferencial sangue - TEA masculino (em relação ao controle masculino).csv', 'Sangue TEA masculino x controle masculino')
...
for fil, name in files:
    ...
    all_changed.to_csv(f'../data/interim/{name}.csv', index=False)
